...
<head>
    ...
    <title>Gold Nail Admin Dashboard</title>
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-logo">
                <!-- You can replace this with an actual logo image or SVG -->
        ...
        <section class="demographics-section">
            ...
            <div class="demographics-grid">
                <div class="metric-card concerns">
                    ...
                    <p id="totalConcerns" class="metric-value">0</p>
                    <p class="metric-description">Customer concerns recorded</p>
                </div>
                <div class="metric-card add-concern">
                    <h3 class="card-header-title">Record New Concern</h3>
                    <button id="addConcernBtn" class="add-concern-btn">
            ...
            <div class="concerns-table-container">
                <table class="concerns-table">
                    ...
                    <tbody id="concernsTableBody">
                        <!-- Concerns will be dynamically added here by JavaScript -->
                    </tbody>
                </table>
            </div>
        </section>
    ...
    <!-- Modal for Adding Concern -->
    <div id="addConcernModal" class="modal-overlay">
        <div class="modal-content">
            <button class="modal-close-btn" id="closeModalBtn">&times;</button>
            <h3>Add New Customer Concern</h3>
            <form id="concernForm">
                <div class="form-group">
                    <label for="concernDate">Date:</label>
                    <input type="date" id="concernDate" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="issueDescription" placeholder="Describe the concern..." required></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="modal-actions">
                    <button type="button" class="modal-btn cancel" id="cancelConcernBtn">Cancel</button>
                    <button type="submit" class="modal-btn submit">Add Concern</button>
                </div>
            </form>
        </div>
    </div>
